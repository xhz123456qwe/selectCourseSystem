...
<div class="container-fluid side" style="height: 500px;">
    ...
    <form method="post" action="${pageContext.request.contextPath}/manager/courseInfo/add">
    <div class="acb">
        <div class="acb1">
            <label>课程名称</label>
    ...
    <div class="acb" style="margin-left: 30px;margin-right: 30px">
        <div class="acb1">
            <label>最大课程容量</label>
            <input type="text" name="maxNumber" style="width: 240px;"><br>
        </div>
        <div class="acb1" style="margin-top: 40px">
            <label>课程描述</label><br/>
            <textarea name="description" cols="31" rows="12">最多200字</textarea><br/>
        </div>
    </div>
    <div class="acb">
        <fieldset>
            ...
            <div>
                <label>开设日期</label><br/>
                <input type="text" name="cYear1" style="width: 40px;margin-right: 10px">年
                <input type="text" name="cMonth1" style="width: 40px;margin-right: 10px">月
                <input type="text" name="cDay1" style="width: 40px;margin-right: 10px">日-
                <div style="width: 100%;height: 10px;"></div>
                <input type="text" name="cYear2" style="width: 40px;margin-right: 10px">年
                <input type="text" name="cMonth2" style="width: 40px;margin-right: 10px">月
                <input type="text" name="cDay2" style="width: 40px;margin-right: 10px">日
            </div>
            <div style="margin-top: 10px">
                <label style="float:left;width: 100%;">开设星期</label><br/>
                <div class="ch2">
